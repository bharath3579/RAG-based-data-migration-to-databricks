CREATE TABLE [sch_anl].[eyp0007_tb_fac_d_wl_st_wat_inj]
(
  ...
  [ind_alloc_inj_vol_bbl] [float],
  [ind_alloc_inj_vol_m3] [float],
  [ind_alloc_inj_vol_sm3] [float],
  [ind_alloc_inj_vol_stb] [float],
  [ind_avg_annulus_press_barg] [float],
  [ind_avg_annulus_press_psig] [float],
  [ind_avg_wh_press_barg] [float],
  [ind_avg_wh_press_psig] [float],
  [ind_avg_wh_temp_c] [float],
  [ind_avg_wh_temp_f] [float],
  [ind_inj_vol_bbl] [float],
  [ind_inj_vol_m3] [float],
  [ind_inj_vol_sm3] [float],
  [ind_inj_vol_stb] [float],
