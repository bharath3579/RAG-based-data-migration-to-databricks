CREATE TABLE [sch_anl].[eyp0007_tb_fac_d_str_der_wat]
(
  ...
  [ind_alloc_net_vol_bbl] [float],
  [ind_alloc_net_vol_m3] [float],
  [ind_alloc_wat_vol_bbl] [float],
  [ind_alloc_wat_vol_m3] [float],
