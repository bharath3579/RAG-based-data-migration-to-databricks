CREATE TABLE [sch_anl].[eyp0007_tb_fac_d_str_meas_oil]
(
  ...
  [ind_grs_vol_oil_stb] [float],
  [ind_grs_vol_oil_sm3] [float],
  [ind_grs_vol_oil_boe] [float],
  [ind_grs_vol_oil_bbl] [float],
  [ind_net_vol_oil_stb] [float],
  [ind_net_vol_oil_sm3] [float],
  ...
  [ind_o_alloc_net_vol_20_stb] [float],
  [ind_o_alloc_net_vol_20_sm3] [float],
  [ind_o_alloc_oil_vol_stb] [float],
  [ind_o_alloc_oil_vol_sm3] [float],
  ...
  [ind_p_alloc_net_vol_20_stb] [float],
  [ind_p_alloc_net_vol_20_sm3] [float],
  [ind_p_alloc_oil_vol_stb] [float],
  [ind_p_alloc_oil_vol_sm3] [float],
