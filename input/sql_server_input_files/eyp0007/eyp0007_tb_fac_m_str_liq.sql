CREATE TABLE [sch_anl].[eyp0007_tb_fac_m_str_liq]
(
  ...
  [ind_calc_grs_vol_mscf] [float],
  [ind_calc_grs_vol_kscf] [float],
  [ind_calc_grs_vol_sm3] [float],
  [ind_calc_net_vol_stb] [float],
  [ind_calc_net_vol_sm3] [float],
  [ind_grs_vol_stb] [float],
  [ind_grs_vol_sm3] [float],
  [ind_grs_vol_day_stb] [float],
  [ind_grs_vol_day_sm3] [float],
  [ind_grs_vol_pre_stb] [float],
  [ind_grs_vol_pre_sm3] [float],
  [ind_net_vol_stb] [float],
  [ind_net_vol_sm3] [float],
  [ind_o_alloc_liq_vol_stb] [float],
  [ind_o_alloc_liq_vol_sm3] [float],
  [ind_o_alloc_liq_vol_15_stb] [float],
  [ind_o_alloc_liq_vol_15_sm3] [float],
