...
val order = Seq("id_vers", "id_choke_model", "des_choke_model", "fec_start_date", "fec_end_date", "des_parent_choke_model", "id_fcty_1", "fec_create_date", "fec_update_date")
...
def transformationDfDim (df: DataFrame): DataFrame = {
    ...
    dfTrn = dfTrn.withColumnRenamed("object_id", "id_choke_model")
                    ...
                    .withColumnRenamed("parent_choke_model_code", "des_parent_choke_model")
...
try {
    ...
    df = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_aux_d_choke_model"))
