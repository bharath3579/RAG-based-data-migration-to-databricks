...
val order = Seq("id_vers", "id_chem_tank", "des_chem_tank", "fec_start_date", "fec_end_date", "id_col_point", "id_fcty_1", "fec_create_date", "fec_update_date")
...
def transformationDfDim (df: DataFrame): DataFrame = {
    ...
    dfTrn = dfTrn.withColumnRenamed("object_id", "id_chem_tank")
                    .withColumnRenamed("name", "des_chem_tank")
...
try {
    ...
    df = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_aux_d_chem_tank"))
