...
val selectAttributesUnitsSeq = Seq("ind_std_net_vol_oil_stb", "ind_std_net_vol_oil_sm3", "ind_grs_vol_wat_bbl", "ind_grs_vol_wat_m3")
...
val dfTransactional = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_d_tank_dip_stat"))
