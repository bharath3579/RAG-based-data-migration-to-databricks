...
val selectAttributesUnitsSeq = Seq("ind_calc_closing_grs_vol_stb", "ind_calc_closing_grs_vol_sm3", "ind_calc_closing_oil_vol_stb", "ind_calc_closing_oil_vol_sm3", "ind_calc_closing_wat_vol_bbl", "ind_calc_closing_wat_vol_m3", "ind_calc_closing_wat_vol_stb", "ind_closing_grs_vol_stb", "ind_closing_grs_vol_sm3", "ind_closing_water_vol_bbl", "ind_closing_water_vol_m3", "ind_closing_water_vol_stb", "ind_opening_grs_vol_stb", "ind_opening_grs_vol_sm3")
...
val dfTransactional = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_d_tank_inv_oil_uc"))
