...
val selectFieldsSeq = Seq("fec_production_day", "id_vers_stream", "id_stream", "des_stream_name", "id_fcty_class_1", "id_col_point", "id_productionunit", "id_area", "id_operator_route", "id_product", "id_licence", "id_disposition_type", "fec_create_date", "fec_update_date")

val selectAttributesUnitsSeq = Seq("ind_grs_vol_stb", "ind_grs_vol_sm3")
...
val dfTransactional = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_m_str_der_ngl_uc"))
