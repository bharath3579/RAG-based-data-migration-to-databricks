...
val selectFieldsSeq = Seq("fec_production_day", "id_vers_stream", "id_stream", "id_fcty_class_1", "id_col_point", "id_productionunit", "id_area", "id_operator_route", "id_product",
 "id_licence", "id_disposition_type", "fec_create_date", "fec_update_date")

val selectAttributesUnitsSeq = Seq("ind_alloc_net_vol_stb","ind_alloc_net_vol_sm3","ind_calc_grs_vol_mscf","ind_calc_grs_vol_kscf","ind_calc_grs_vol_sm3","ind_calc_net_vol_stb",
"ind_calc_net_vol_sm3","ind_grs_vol_stb","ind_grs_vol_sm3","ind_grs_vol_day_stb","ind_grs_vol_day_sm3","ind_grs_vol_pre_stb","ind_grs_vol_pre_sm3","ind_net_vol_stb","ind_net_vol_sm3",
"ind_o_alloc_liq_vol_stb","ind_o_alloc_liq_vol_sm3","ind_o_alloc_liq_vol_15_stb","ind_o_alloc_liq_vol_15_sm3","ind_o_alloc_net_vol_stb","ind_o_alloc_net_vol_sm3","ind_o_alloc_net_vol_20_stb",
"ind_o_alloc_net_vol_20_sm3","ind_p_alloc_liq_vol_stb","ind_p_alloc_liq_vol_sm3","ind_p_alloc_net_vol_stb","ind_p_alloc_net_vol_sm3"
)
...
val dfTransactional = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_m_str_liq_uc"))
...
try {
    ...
    df = joinWithMst(dfTransactional, dfMstStrem, Seq("fec_production_day", "id_stream", "fec_update_date"), 
    ...
    df = joinWithDim(df, dfDimDispType, Seq("fec_production_day", "id_stream", "fec_update_date"), "disposition_type_id", "id_disp_type", "fec_production_day", "fec_start_date", "left")
