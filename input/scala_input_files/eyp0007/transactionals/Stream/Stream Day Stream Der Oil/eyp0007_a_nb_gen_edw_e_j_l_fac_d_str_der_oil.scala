...
"id_product", "id_licence", "id_disposition_type", "fec_create_date", "fec_update_date")

val selectAttributesUnitsSeq = Seq("ind_alloc_net_vol_stb","ind_alloc_net_vol_sm3","ind_grs_vol_oil_stb","ind_grs_vol_oil_sm3",
"ind_net_vol_oil_stb","ind_net_vol_oil_sm3","ind_o_alloc_oil_vol_stb","ind_o_alloc_oil_vol_sm3","ind_p_alloc_oil_vol_stb",
"ind_p_alloc_oil_vol_sm3")
...
val dfTransactional = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_d_str_der_oil_uc"))
