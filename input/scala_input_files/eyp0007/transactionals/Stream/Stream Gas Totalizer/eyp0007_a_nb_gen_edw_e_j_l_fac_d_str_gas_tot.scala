...
val selectAttributesUnitsSeq = Seq("ind_daily_rate_mscfperday", "ind_daily_rate_kscfperday", "ind_daily_rate_sm3perday", "ind_grs_vol_mscf", "ind_grs_vol_kscf", "ind_grs_vol_sm3", "ind_net_vol_mscf", "ind_net_vol_kscf", "ind_net_vol_sm3")
...
val dfTransactional = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_d_str_gas_tot_uc"))
