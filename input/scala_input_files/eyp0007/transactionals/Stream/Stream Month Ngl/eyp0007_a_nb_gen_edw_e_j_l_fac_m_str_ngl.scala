...
val selectAttributesUnitsSeq = Seq("ind_alloc_vol_stb", "ind_alloc_vol_sm3", "ind_alloc_vol_gallon", "ind_calc_net_vol_gallon", "ind_grs_vol_stb", "ind_grs_vol_sm3", "ind_grs_vol_gallon", "ind_o_alloc_liq_vol_stb", "ind_o_alloc_liq_vol_sm3", "ind_p_alloc_liq_vol_stb", "ind_p_alloc_liq_vol_sm3")
...
val dfTransactional = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_m_str_ngl_uc"))
