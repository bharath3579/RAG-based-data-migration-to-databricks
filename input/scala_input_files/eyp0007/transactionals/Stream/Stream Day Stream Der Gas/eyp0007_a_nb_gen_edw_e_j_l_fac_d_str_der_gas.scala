...
val selectFieldsSeq = Seq("fec_production_day", "id_vers_stream", "id_stream", "id_fcty_class_1", "id_col_point", 
"id_productionunit", "id_area", "id_operator_route", "id_product", "id_licence", "id_disposition_type", "fec_create_date", 
"fec_update_date")

val selectAttributesUnitsSeq = Seq("ind_o_alloc_gas_vol_mscf", "ind_o_alloc_gas_vol_sm3", "ind_o_alloc_gas_vol_kscf", 
"ind_o_alloc_gas_vol_15_ksm3_15", "ind_o_alloc_gas_vol_15_kscf", "ind_p_alloc_gas_vol_mscf", "ind_p_alloc_gas_vol_sm3", 
"ind_p_alloc_gas_vol_kscf", "ind_p_alloc_gas_vol_15_ksm3_15", "ind_p_alloc_gas_vol_15_kscf", "ind_alloc_net_vol_mscf",
"ind_alloc_net_vol_kscf", "ind_alloc_net_vol_sm3", "ind_grs_vol_gas_mscf", "ind_grs_vol_gas_kscf", "ind_grs_vol_gas_sm3",
"ind_net_vol_gas_mscf", "ind_net_vol_gas_kscf", "ind_net_vol_gas_sm3")
...
val dfTransactional = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_d_str_der_gas_uc"))
