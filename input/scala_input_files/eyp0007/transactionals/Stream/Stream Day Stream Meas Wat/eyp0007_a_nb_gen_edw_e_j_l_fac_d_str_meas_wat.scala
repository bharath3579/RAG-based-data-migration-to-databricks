...
val selectAttributesUnitsSeq = Seq("ind_alloc_water_vol_bbl","ind_alloc_water_vol_m3","ind_alloc_water_vol_stb",
"ind_daily_net_vol_bbl","ind_daily_net_vol_m3","ind_grs_vol_wat_sm3","ind_grs_vol_wat_m3","ind_grs_vol_wat_stb",
"ind_grs_vol_wat_bbl","ind_grs_vol_wat_boe","ind_o_alloc_water_vol_stb","ind_o_alloc_water_vol_bbl",
"ind_o_alloc_water_vol_m3","ind_p_alloc_water_vol_stb","ind_p_alloc_water_vol_bbl","ind_p_alloc_water_vol_m3")
...
val dfTransactional = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_d_str_meas_wat_uc"))
