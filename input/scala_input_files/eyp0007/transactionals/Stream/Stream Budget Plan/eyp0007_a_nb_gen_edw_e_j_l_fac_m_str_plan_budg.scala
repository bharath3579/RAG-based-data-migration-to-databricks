...
val selectFieldsSeq = Seq("fec_production_day", "id_vers_stream", "id_stream", "id_fcty_class_1", "id_col_point", "id_productionunit", "id_area", "id_operator_route", "id_product", "id_licence", "id_disposition_type", "fec_start_date", "des_comments", "fec_create_date", "fec_update_date")

val selectAttributesUnitsSeq = Seq("ind_cond_rate_kstbpermth", "ind_cond_rate_stbpermth", "ind_cond_rate_net_kstbpermth", "ind_cond_rate_net_stbpermth", 
"ind_cond_rate_wi_kstbpermth", "ind_cond_rate_wi_stbpermth", "ind_gas_rate_mmscfpermth", "ind_gas_rate_kscfpermth", "ind_gas_rate_net_mmscfpermth",
 "ind_gas_rate_net_kscfpermth", "ind_gas_rate_wi_mmscfpermth", "ind_gas_rate_wi_kscfpermth", "ind_ngl_rate_mscfperday", "ind_ngl_rate_kscfperday",
  "ind_ngl_rate_sm3perday", "ind_ngl_rate_kstbpermth", "ind_ngl_rate_stbpermth", "ind_ngl_rate_net_kstbpermth", "ind_ngl_rate_net_stbpermth", 
  "ind_ngl_rate_net_mmscfpermth", "ind_ngl_rate_net_kscfpermth", "ind_ngl_rate_wi_kstbpermth", "ind_ngl_rate_wi_stbpermth", "ind_ngl_rate_wi_mmscfpermth", 
  "ind_ngl_rate_wi_kscfpermth", "ind_oil_rate_kstbpermth", "ind_oil_rate_stbpermth", "ind_oil_rate_net_kstbpermth", "ind_oil_rate_net_stbpermth", 
  "ind_oil_rate_wi_kstbpermth", "ind_oil_rate_wi_stbpermth")
...
val dfTransactional = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_m_str_plan_budg_uc"))
...
try {
    ...
    df = joinWithMst(dfTransactional, dfMstStrem, Seq("fec_production_day", "id_stream", "fec_start_date"), 
    ...
    df = joinWithDim(df, dfDimDispType, Seq("fec_production_day", "id_stream", "fec_start_date"), "disposition_type_id", "id_disp_type", "fec_production_day", "fec_start_date", "left")
