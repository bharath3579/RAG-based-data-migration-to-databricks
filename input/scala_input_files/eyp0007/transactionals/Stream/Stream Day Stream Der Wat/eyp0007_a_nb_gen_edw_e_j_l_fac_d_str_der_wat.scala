...
"id_productionunit", "id_area", "id_operator_route", "id_product", "id_licence", "id_disposition_type", 
"fec_create_date", "fec_update_date")

val selectAttributesUnitsSeq = Seq("ind_alloc_net_vol_bbl","ind_alloc_net_vol_m3","ind_daily_net_vol_bbl",
"ind_daily_net_vol_m3","ind_grs_vol_wat_stb","ind_grs_vol_wat_sm3","ind_o_alloc_water_vol_bbl",
"ind_o_alloc_water_vol_m3","ind_p_alloc_water_vol_bbl","ind_p_alloc_water_vol_m3", "ind_alloc_wat_vol_bbl",
"ind_alloc_wat_vol_m3")
...
val dfTransactional = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_d_str_der_wat_uc"))
