...
val selectFieldsSeq = Seq("fec_comment_day","id_vers_facility_class_1","id_facility_class_1","id_area","id_productionunit","id_comment",
"des_comment_even_type","des_comment_type","des_comments","des_report_ind","fec_start_date","fec_create_date","fec_update_date")
...
val dfFacObjItemComment = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_d_ob_it_comment"))
...
try {
    ...
    df = joinWithMst(dfFacObjItemComment, dfMstFctyClass1, Seq("fec_comment_day","id_comment", "id_facility_class_1",  "fec_start_date"), "id_facility_class_1", "object_id", "fec_comment_day", "daytime" ,
    ...
    df = joinWithDimSelect(df, dfDimFctyClass1, Seq("fec_comment_day","id_comment", "id_facility_class_1",  "fec_start_date"), "id_facility_class_1", "id_facility_class_1", "fec_comment_day", "fec_start_date", Seq("id_vers"), "left")
    df = df.withColumnRenamed("id_vers", "id_vers_facility_class_1")


    df = joinWithDim(df, dfDimArea, Seq("fec_comment_day","id_comment", "id_facility_class_1",  "fec_start_date"), "op_area_id", "id_area", "fec_comment_day", "fec_start_date", "left")
    df = df.drop("op_area_id").withColumnRenamed("id_vers", "id_area")

    df = joinWithDim(df, dfDimProdUnit, Seq("fec_comment_day","id_comment", "id_facility_class_1",  "fec_start_date"), "op_productionunit_id", "id_productunit", "fec_comment_day", "fec_start_date", "left")
