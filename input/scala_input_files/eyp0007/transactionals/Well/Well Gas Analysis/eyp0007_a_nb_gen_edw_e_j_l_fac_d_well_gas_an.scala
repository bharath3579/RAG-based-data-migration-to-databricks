...
val selectFieldsSeq = Seq("fec_production_day", "id_vers_well", "id_well", "id_commercial_entity", "id_facility_class_1", "id_well_hookup", "id_well_hole", "id_area", "id_productionunit", "id_geo_area", "id_field_cds", "id_field",  "id_basin", "id_operator_route", "id_col_point", "id_licence", "fec_lab_date", "fec_valid_from", 
                            "ind_analysis_no", "ind_analysis_no2", "des_analysis_status", "fec_create_date", "fec_update_date")
...
val dfFacWellGasAn = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_d_well_gas_an"))
...
try {
    ...
    df = joinWithMst(dfFacWellGasAn, dfMstWell, Seq("fec_production_day","id_well", "fec_update_date"), "id_well", "object_id", "fec_production_day", "daytime" ,
