...
def transformToOffAndPrel (df: DataFrame): DataFrame = {

  //ind_z_p_alloc_gl_vol_bbl y ind_z_p_alloc_gl_vol_m3 quedan fuera por no estar en las unidades correctas

    val selectFieldsSeqFinal = Seq("fec_production_day", "id_vers_well", "id_well", "id_commercial_entity", "id_facility_class_1", "id_well_hookup", "id_well_hole", "id_area", "id_productionunit", 
    "id_geo_area", "id_field_cds", 
   "id_field", "id_basin", "id_operator_route", "id_col_point", "id_licence","ind_cond_vol_factor", "ind_gas_vol_factor", "ind_net_oil_vol_factor", "ind_water_vol_factor", 
   "ind_z_o_alloc_gl_vol_kscf","ind_alloc_cond_vol_sm3", "ind_alloc_cond_vol_stb", "ind_alloc_gas_vol_kscf", "ind_alloc_gas_vol_mscf", "ind_alloc_gas_vol_sm3", 
  ...
  "ind_theor_water_rate_bbl", "ind_theor_water_rate_m3", "ind_theor_water_rate_sm3perday", "ind_theor_water_rate_stbperday", "fec_create_date", "fec_update_date")
    ...
    dfTrn = dfTrn.withColumn("fix_ind_o_alloc_cond_vol_stb",  //ind_o_alloc_cond_vol_stb
               when(col("id_bu_fac").isin("GBR", "MBU"), col("ind_z_o_alloc_cond_vol_stb"))
              .otherwise(col("ind_o_alloc_cond_vol_stb"))).drop("ind_z_o_alloc_cond_vol_stb", "ind_o_alloc_cond_vol_stb")
              .withColumnRenamed("fix_ind_o_alloc_cond_vol_stb", "ind_o_alloc_cond_vol_stb")
              .withColumn("fix_ind_o_alloc_gas_vol_kscf",    //ind_o_alloc_gas_vol_kscf
               when(col("id_bu_fac").isin("GBR", "MBU"), col("ind_z_o_alloc_gas_vol_kscf"))
              .otherwise(col("ind_o_alloc_gas_vol_kscf"))).drop("ind_z_o_alloc_gas_vol_kscf", "ind_o_alloc_gas_vol_kscf")
              .withColumnRenamed("fix_ind_o_alloc_gas_vol_kscf", "ind_o_alloc_gas_vol_kscf")
              .withColumn("fix_ind_o_alloc_gas_vol_mscf",    //ind_o_alloc_gas_vol_mscf
               when(col("id_bu_fac").isin("GBR", "MBU"), col("ind_z_o_alloc_gas_vol_mscf"))
              .otherwise(col("ind_o_alloc_gas_vol_mscf"))).drop("ind_z_o_alloc_gas_vol_mscf", "ind_o_alloc_gas_vol_mscf")
              .withColumnRenamed("fix_ind_o_alloc_gas_vol_mscf", "ind_o_alloc_gas_vol_mscf")
              .withColumn("fix_ind_o_alloc_gas_vol_sm3",    //ind_o_alloc_gas_vol_sm3
               when(col("id_bu_fac").isin("GBR", "MBU"), col("ind_z_o_alloc_gas_vol_sm3"))
              .otherwise(col("ind_o_alloc_gas_vol_sm3"))).drop("ind_z_o_alloc_gas_vol_sm3", "ind_o_alloc_gas_vol_sm3")
              .withColumnRenamed("fix_ind_o_alloc_gas_vol_sm3", "ind_o_alloc_gas_vol_sm3")
              .withColumn("fix_ind_o_alloc_net_oil_vol_sm3",    //ind_o_alloc_net_oil_vol_sm3
               when(col("id_bu_fac").isin("GBR", "MBU"), col("ind_z_o_alloc_net_oil_vol_sm3"))
              .otherwise(col("ind_o_alloc_net_oil_vol_sm3"))).drop("ind_z_o_alloc_net_oil_vol_sm3", "ind_o_alloc_net_oil_vol_sm3")
              .withColumnRenamed("fix_ind_o_alloc_net_oil_vol_sm3", "ind_o_alloc_net_oil_vol_sm3")
              .withColumn("fix_ind_o_alloc_net_oil_vol_stb",    //ind_o_alloc_net_oil_vol_stb
               when(col("id_bu_fac").isin("GBR", "MBU"), col("ind_z_o_alloc_net_oil_vol_stb"))
              .otherwise(col("ind_o_alloc_net_oil_vol_stb"))).drop("ind_z_o_alloc_net_oil_vol_stb", "ind_o_alloc_net_oil_vol_stb")
              .withColumnRenamed("fix_ind_o_alloc_net_oil_vol_stb", "ind_o_alloc_net_oil_vol_stb")
              .withColumn("fix_ind_o_alloc_water_vol_bbl",    //ind_o_alloc_water_vol_bbl
               when(col("id_bu_fac").isin("GBR", "MBU"), col("ind_z_o_alloc_water_vol_bbl"))
              .otherwise(col("ind_o_alloc_water_vol_bbl"))).drop("ind_z_o_alloc_water_vol_bbl", "ind_o_alloc_water_vol_bbl")
              .withColumnRenamed("fix_ind_o_alloc_water_vol_bbl", "ind_o_alloc_water_vol_bbl")
               .withColumn("fix_ind_o_alloc_water_vol_m3",    //ind_o_alloc_water_vol_m3
               when(col("id_bu_fac").isin("GBR", "MBU"), col("ind_z_o_alloc_water_vol_m3"))
              .otherwise(col("ind_o_alloc_water_vol_m3"))).drop("ind_z_o_alloc_water_vol_m3", "ind_o_alloc_water_vol_m3")
              .withColumnRenamed("fix_ind_o_alloc_water_vol_m3", "ind_o_alloc_water_vol_m3")
              .withColumn("fix_ind_p_alloc_cond_vol_stb",  //ind_p_alloc_cond_vol_stb
               when(col("id_bu_fac").isin("GBR", "MBU"), col("ind_z_p_alloc_cond_vol_stb"))
              .otherwise(col("ind_p_alloc_cond_vol_stb"))).drop("ind_z_p_alloc_cond_vol_stb", "ind_p_alloc_cond_vol_stb")
              .withColumnRenamed("fix_ind_p_alloc_cond_vol_stb", "ind_p_alloc_cond_vol_stb")
              .withColumn("fix_ind_p_alloc_gas_vol_kscf",    //ind_p_alloc_gas_vol_kscf
               when(col("id_bu_fac").isin("GBR", "MBU"), col("ind_z_p_alloc_gas_vol_kscf"))
              .otherwise(col("ind_p_alloc_gas_vol_kscf"))).drop("ind_z_p_alloc_gas_vol_kscf", "ind_p_alloc_gas_vol_kscf")
              .withColumnRenamed("fix_ind_p_alloc_gas_vol_kscf", "ind_p_alloc_gas_vol_kscf")
              .withColumn("fix_ind_p_alloc_gas_vol_mscf",    //ind_p_alloc_gas_vol_mscf
               when(col("id_bu_fac").isin("GBR", "MBU"), col("ind_z_p_alloc_gas_vol_mscf"))
              .otherwise(col("ind_p_alloc_gas_vol_mscf"))).drop("ind_z_p_alloc_gas_vol_mscf", "ind_p_alloc_gas_vol_mscf")
              .withColumnRenamed("fix_ind_p_alloc_gas_vol_mscf", "ind_p_alloc_gas_vol_mscf")
              .withColumn("fix_ind_p_alloc_gas_vol_sm3",    //ind_p_alloc_gas_vol_sm3
               when(col("id_bu_fac").isin("GBR", "MBU"), col("ind_z_p_alloc_gas_vol_sm3"))
              .otherwise(col("ind_p_alloc_gas_vol_sm3"))).drop("ind_z_p_alloc_gas_vol_sm3", "ind_p_alloc_gas_vol_sm3")
              .withColumnRenamed("fix_ind_p_alloc_gas_vol_sm3", "ind_p_alloc_gas_vol_sm3")
              .withColumn("fix_ind_p_alloc_net_oil_vol_sm3",    //ind_p_alloc_net_oil_vol_sm3
               when(col("id_bu_fac").isin("GBR", "MBU"), col("ind_z_p_alloc_net_oil_vol_sm3"))
              .otherwise(col("ind_p_alloc_net_oil_vol_sm3"))).drop("ind_z_p_alloc_net_oil_vol_sm3", "ind_p_alloc_net_oil_vol_sm3")
              .withColumnRenamed("fix_ind_p_alloc_net_oil_vol_sm3", "ind_p_alloc_net_oil_vol_sm3")
              .withColumn("fix_ind_p_alloc_net_oil_vol_stb",    //ind_p_alloc_net_oil_vol_stb
               when(col("id_bu_fac").isin("GBR", "MBU"), col("ind_z_p_alloc_net_oil_vol_stb"))
              .otherwise(col("ind_p_alloc_net_oil_vol_stb"))).drop("ind_z_p_alloc_net_oil_vol_stb", "ind_p_alloc_net_oil_vol_stb")
              .withColumnRenamed("fix_ind_p_alloc_net_oil_vol_stb", "ind_p_alloc_net_oil_vol_stb")
              .withColumn("fix_ind_p_alloc_water_vol_bbl",    //ind_p_alloc_water_vol_bbl
               when(col("id_bu_fac").isin("GBR", "MBU"), col("ind_z_p_alloc_water_vol_bbl"))
              .otherwise(col("ind_p_alloc_water_vol_bbl"))).drop("ind_z_p_alloc_water_vol_bbl", "ind_p_alloc_water_vol_bbl")
              .withColumnRenamed("fix_ind_p_alloc_water_vol_bbl", "ind_p_alloc_water_vol_bbl")
               .withColumn("fix_ind_p_alloc_water_vol_m3",    //ind_p_alloc_water_vol_m3
               when(col("id_bu_fac").isin("GBR", "MBU"), col("ind_z_p_alloc_water_vol_m3"))
              .otherwise(col("ind_p_alloc_water_vol_m3"))).drop("ind_z_p_alloc_water_vol_m3", "ind_p_alloc_water_vol_m3")
              .withColumnRenamed("fix_ind_p_alloc_water_vol_m3", "ind_p_alloc_water_vol_m3")


    dfTrn = dfTrn.select(selectFieldsSeqFinal.map(col): _*)
...
val selectFieldsSeq = Seq("fec_production_day", "id_vers_well", "id_well", "id_commercial_entity", "id_facility_class_1", "id_well_hookup", "id_well_hole", "id_area", "id_productionunit", "id_geo_area", "id_field_cds", 
"id_field", "id_basin", "id_operator_route", "id_col_point", "id_licence","ind_cond_vol_factor", "ind_gas_vol_factor", "ind_net_oil_vol_factor", "ind_water_vol_factor", 
"ind_z_o_alloc_cond_vol_stb","ind_z_o_alloc_gl_vol_kscf","ind_z_p_alloc_cond_vol_stb","fec_create_date", "fec_update_date", "id_bu_fac")


val selectAttributesUnitsSeq = Seq(
  "ind_alloc_cond_vol_sm3", "ind_alloc_cond_vol_stb", "ind_alloc_gas_vol_kscf", "ind_alloc_gas_vol_mscf", "ind_alloc_gas_vol_sm3", 
  "ind_alloc_gl_vol_kscf", "ind_alloc_gl_vol_mscf", "ind_alloc_gl_vol_sm3", "ind_alloc_net_oil_vol_sm3", "ind_alloc_net_oil_vol_stb", 
  "ind_alloc_water_vol_bbl", "ind_alloc_water_vol_m3", "ind_alloc_water_vol_sm3", "ind_alloc_water_vol_stb", "ind_o_alloc_cond_vol_15_sm3", 
  "ind_o_alloc_cond_vol_15_stb", "ind_o_alloc_cond_vol_sm3", "ind_o_alloc_cond_vol_stb", "ind_o_alloc_gas_vol_15_kscf", "ind_o_alloc_gas_vol_15_mscf", 
  "ind_o_alloc_gas_vol_15_sm3", "ind_o_alloc_gas_vol_20_kscf", "ind_o_alloc_gas_vol_20_mscf", "ind_o_alloc_gas_vol_20_sm3", "ind_o_alloc_gas_vol_kscf", 
  ...
  "ind_theor_gl_rate_kscfperday", "ind_theor_gl_rate_mscf", "ind_theor_gl_rate_mscfperday", "ind_theor_gl_rate_sm3", "ind_theor_gl_rate_sm3perday", 
  "ind_theor_net_oil_rate_sm3", "ind_theor_net_oil_rate_sm3perday", "ind_theor_net_oil_rate_stb", "ind_theor_net_oil_rate_stbperday", 
  "ind_theor_water_rate_bbl", "ind_theor_water_rate_m3", "ind_theor_water_rate_sm3perday", "ind_theor_water_rate_stbperday", "ind_z_o_alloc_gas_vol_kscf", 
  "ind_z_o_alloc_gas_vol_mscf", "ind_z_o_alloc_gas_vol_sm3", "ind_z_o_alloc_net_oil_vol_sm3", "ind_z_o_alloc_net_oil_vol_stb", "ind_z_o_alloc_water_vol_bbl", 
  "ind_z_o_alloc_water_vol_m3", "ind_z_p_alloc_gas_vol_kscf", "ind_z_p_alloc_gas_vol_mscf", "ind_z_p_alloc_gas_vol_sm3", "ind_z_p_alloc_gl_vol_bbl", 
  "ind_z_p_alloc_gl_vol_m3", "ind_z_p_alloc_net_oil_vol_sm3", "ind_z_p_alloc_net_oil_vol_stb", "ind_z_p_alloc_water_vol_bbl", "ind_z_p_alloc_water_vol_m3"
)
...
val dfFacWellPeriodStatus = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_d_pwel_day_all_uc"))
...
try {
    ...
    df = joinWithMst(dfFacWellPeriodStatus, dfMstWell, Seq("fec_production_day","id_well", "fec_update_date"), "id_well", "object_id", "fec_production_day", "daytime" ,
