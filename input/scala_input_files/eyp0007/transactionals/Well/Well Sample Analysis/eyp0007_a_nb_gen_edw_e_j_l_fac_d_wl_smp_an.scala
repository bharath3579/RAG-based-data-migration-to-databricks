...
"id_operator_route","id_col_point","id_licence","fec_create_date","fec_update_date")

val selectAttributesUnitsSeq = Seq("ind_bs_w_frac","ind_bs_w_pct")
...
val dfFacWellSampleAnalysis = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_d_wl_smp_an"))
...
try {
    ...
    df = joinWithMst(dfFacWellSampleAnalysis, dfMstWell, Seq("fec_production_day","id_well", "fec_update_date"), "id_well", "object_id", "fec_production_day", "daytime" ,
