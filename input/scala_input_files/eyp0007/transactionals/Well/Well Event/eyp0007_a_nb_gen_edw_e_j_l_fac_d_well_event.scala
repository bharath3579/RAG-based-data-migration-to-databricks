...
val selectFieldsSeq = Seq("fec_production_day", "id_vers_well", "id_well", "id_commercial_entity", "id_facility_class_1", "id_well_hookup", "id_well_hole", "id_area", "id_productionunit", "id_geo_area", "id_field_cds", "id_field", "id_basin",
                        "id_operator_route", "id_col_point", "id_licence", "ind_potential", "fec_create_date", "fec_update_date")
...
val dfFacWellEvent:DataFrame = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_d_well_event")).withColumn("ind_potential", when(col("ind_potential") === "YME Class A Oil", "A")
                                                .when(col("ind_potential") === "YME Class B Oil", "B")
                                                .when(col("ind_potential") === "YME Class C Oil", "C")
                                                .otherwise("Z"))
