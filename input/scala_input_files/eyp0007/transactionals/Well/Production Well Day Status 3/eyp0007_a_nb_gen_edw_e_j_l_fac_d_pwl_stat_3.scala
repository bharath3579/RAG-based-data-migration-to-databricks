...
val selectAttributesUnitsSeq = Seq("ind_z_low_def_gas_mscf", "ind_z_low_def_gas_kscf", "ind_z_low_def_gas_sm3", "ind_z_low_def_cond_stb", "ind_z_low_def_cond_sm3",
"ind_z_low_def_oil_stb", "ind_z_low_def_oil_sm3")
...
val dfTransactional = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_d_pwl_stat_3_uc"))
