...
val selectAttributesUnitsSeq = Seq("ind_alloc_inj_vol_kscf", "ind_alloc_inj_vol_mscf", "ind_alloc_inj_vol_sm3", "ind_annulus_press_barg", "ind_annulus_press_psig", "ind_avg_bh_press_barg", "ind_avg_bh_press_psig", "ind_avg_bh_temp_c", "ind_avg_bh_temp_f", "ind_avg_wh_press_barg", "ind_avg_wh_press_psig", "ind_avg_wh_temp_c", "ind_avg_wh_temp_f", "ind_inj_vol_kscf", "ind_inj_vol_mscf", "ind_inj_vol_sm3")
...
val dfTransactional = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_d_wl_st_gas_inj_uc")).withColumnRenamed("id_bu_fac", "id_bu")
