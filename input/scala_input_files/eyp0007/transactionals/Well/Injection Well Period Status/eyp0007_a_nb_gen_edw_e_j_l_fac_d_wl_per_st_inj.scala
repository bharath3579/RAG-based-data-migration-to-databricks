...
val dfFacWellPeriodStatus = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_d_wl_per_st_inj"))
...
try {
  ...
  dfDup.printSchema()
    val dfFormatted = applyDDLFromTableToDF(dfDup,getObject(targetFinal("target_object").toString))
