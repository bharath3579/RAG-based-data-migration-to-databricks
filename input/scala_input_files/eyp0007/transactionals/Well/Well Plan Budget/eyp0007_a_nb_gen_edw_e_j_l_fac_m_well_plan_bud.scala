...
val selectAttributesUnitsSeq = Seq("ind_cond_rate_kstbpermth", "ind_cond_rate_stbpermth", "ind_cond_rate_net_kstbpermth", "ind_cond_rate_net_stbpermth", "ind_cond_rate_wi_kstbpermth", 
"ind_cond_rate_wi_stbpermth", "ind_gas_rate_mmscfpermth", "ind_gas_rate_kscfpermth", "ind_gas_rate_net_mmscfpermth", "ind_gas_rate_net_kscfpermth", "ind_gas_rate_wi_mmscfpermth", 
"ind_gas_rate_wi_kscfpermth", "ind_ngl_rate_mscfperday", "ind_ngl_rate_kscfperday", "ind_ngl_rate_sm3perday", "ind_ngl_rate_kstbpermth", "ind_ngl_rate_stbpermth", "ind_ngl_rate_net_kstbpermth",
 "ind_ngl_rate_net_stbpermth", "ind_ngl_rate_net_mmscfpermth", "ind_ngl_rate_net_kscfpermth", "ind_ngl_rate_wi_kstbpermth", "ind_ngl_rate_wi_stbpermth", "ind_ngl_rate_wi_mmscfpermth", 
 "ind_ngl_rate_wi_kscfpermth", "ind_oil_rate_kstbpermth", "ind_oil_rate_stbpermth", "ind_oil_rate_net_kstbpermth", "ind_oil_rate_net_stbpermth", "ind_oil_rate_wi_kstbpermth", 
 "ind_oil_rate_wi_stbpermth", "ind_water_rate_kstbpermth", "ind_water_rate_stbpermth", "ind_water_rate_net_kstbpermth", "ind_water_rate_net_stbpermth", "ind_water_rate_wi_kstbpermth", 
 "ind_water_rate_wi_stbpermth"
)
...
val dfTransactional = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_m_well_plan_bud_uc"))
