...
// MAGIC %md
// MAGIC # Código que implementa la lógica

// COMMAND ----------

val selectFieldsSeq = Seq("fec_production_day", "id_vers_well", "id_well", 
"id_commercial_entity", "id_facility_class_1", "id_well_hookup", "id_well_hole", 
"id_area", "id_productionunit", "id_geo_area", "id_field_cds", "id_field",  
"id_basin", "id_operator_route", "id_col_point", "id_licence", "des_choke_prod","ind_avg_choke_size",
"ind_avg_choke_size_2","des_choke_uom","ind_avg_gl_choke_size","des_avg_gl_choke_uom","des_comments",
"ind_calc_on_stream_hrs","fec_create_date", "fec_update_date")

val selectAttributesUnitsSeq = Seq("ind_annulus_press_psig","ind_annulus_press_barg","ind_avg_bh_press_psig","ind_avg_bh_press_barg",
...
"ind_avg_wh_temp_f","ind_avg_wh_temp_c","ind_avg_wh_temp_2_f","ind_avg_wh_temp_2_c")
...
val dfTransactional = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_d_pwl_stat_uc"))
