...
val selectAttributesUnitsSeq = Seq("ind_cond_rate_mth_kstbpermth","ind_cond_rate_mth_stbpermth","ind_cond_rate_mth_net_kstbpermth",
"ind_cond_rate_mth_net_stbpermth","ind_cond_rate_mth_wi_kstbpermth","ind_cond_rate_mth_wi_stbpermth","ind_gas_rate_mth_mmscfpermth",
"ind_gas_rate_mth_kscfpermth","ind_gas_rate_mth_net_mmscfpermth","ind_gas_rate_mth_net_kscfpermth","ind_gas_rate_mth_wi_mmscfpermth",
"ind_gas_rate_mth_wi_kscfpermth","ind_ngl_rate_mth_mscfperday","ind_ngl_rate_mth_kscfperday","ind_ngl_rate_mth_sm3perday",
"ind_ngl_rate_mth_kstbpermth","ind_ngl_rate_mth_stbpermth","ind_oil_rate_mth_kstbpermth","ind_oil_rate_mth_stbpermth",
"ind_oil_rate_mth_net_kstbpermth","ind_oil_rate_mth_net_stbpermth","ind_oil_rate_mth_wi_kstbpermth","ind_oil_rate_mth_wi_stbpermth",
"ind_water_rate_mth_kstbpermth","ind_water_rate_mth_stbpermth","ind_water_rate_mth_net_kstbpermth","ind_water_rate_mth_net_stbpermth",
"ind_water_rate_mth_wi_kstbpermth","ind_water_rate_mth_wi_stbpermth"
)
...
val dfTransactional = getDataFromSource(sourcesFinal("am_eyp0007_trn_tb_fac_m_fld_plan_budg_uc"))
