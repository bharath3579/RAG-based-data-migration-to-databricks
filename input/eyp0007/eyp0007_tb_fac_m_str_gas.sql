CREATE TABLE [sch_anl].[eyp0007_tb_fac_m_str_gas]
(
  ...
  [ind_alloc_vol_mscf] [float],
  [ind_alloc_vol_kscf] [float],
  [ind_alloc_vol_sm3] [float],
  [ind_calc_grs_vol_mscf] [float],
  [ind_calc_grs_vol_kscf] [float],
  [ind_calc_grs_vol_sm3] [float],
  [ind_calc_net_vol_mscf] [float],
  [ind_calc_net_vol_kscf] [float],
  [ind_calc_net_vol_sm3] [float],
  [ind_daily_calc_mscf] [float],
  [ind_daily_calc_kscf] [float],
  [ind_daily_calc_sm3] [float],
  ...
  [ind_o_alloc_net_vol_20_mscf] [float],
  [ind_o_alloc_net_vol_20_kscf] [float],
  ...
  [ind_prelim_calc_mscf] [float],
  [ind_prelim_calc_kscf] [float],
  [ind_prelim_calc_sm3] [float],
  [ind_prov_calc_mscf] [float],
  [ind_prov_calc_kscf] [float],
  [ind_prov_calc_sm3] [float],
