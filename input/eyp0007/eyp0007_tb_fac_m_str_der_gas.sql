CREATE TABLE [sch_anl].[eyp0007_tb_fac_m_str_der_gas]
(
  ...
  [ind_o_alloc_net_vol_mscf] [float],
  [ind_o_alloc_net_vol_sm3] [float],
  [ind_o_alloc_net_vol_kscf] [float],
  [ind_o_alloc_net_vol_15_mscf] [float],
  [ind_o_alloc_net_vol_15_kscf] [float],
  [ind_o_alloc_net_vol_15_sm3] [float],
  [ind_p_alloc_gas_vol_mscf] [float],
  [ind_p_alloc_gas_vol_kscf] [float],
  [ind_p_alloc_gas_vol_sm3] [float],
  [ind_p_alloc_net_vol_mscf] [float],
  [ind_p_alloc_net_vol_sm3] [float],
  [ind_p_alloc_net_vol_kscf] [float],
